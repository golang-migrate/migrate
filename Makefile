...
build-cli: clean
	...
	cd ./cmd/migrate && CGO_ENABLED=0 GOOS=linux GOARCH=mips64 go build -a -o ../../cli/build/migrate.linux-mips64 -ldflags='-X main.Version=$(VERSION) -extldflags "-static"' -tags '$(DATABASE) $(SOURCE)' .
