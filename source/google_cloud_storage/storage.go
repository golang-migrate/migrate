...
func (g *gcs) ReadUp(version uint) (io.ReadCloser, source.Executor, string, error) {
...
func (g *gcs) ReadDown(version uint) (io.ReadCloser, source.Executor, string, error) {
...
func (g *gcs) open(m *source.Migration) (io.ReadCloser, source.Executor, string, error) {
