...
`rdsmysql://user:password@tcp(host:port)/dbname?query`

| URL Query  | WithInstance Config | Description |
|------------|---------------------|-------------|
| `x-region` | | Cloud provider region identifier |
...
import (
    ...
    "github.com/golang-migrate/migrate/v4/database/rdsmysql"
    _ "github.com/golang-migrate/migrate/v4/source/file"
)

func main() {
    db, _ := sql.Open("rdsmysql", "user:password@tcp(host:port)/dbname?multiStatements=true")
