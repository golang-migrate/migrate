...
| `x-lock-retry-max-interval` | `Locking` | When acquiring a lock fails, retries are used with an exponential backoff. This parameter specified what is the maximum interval between retries (default: 1000ms) |
