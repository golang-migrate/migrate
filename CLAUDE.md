...
**YOU ARE IN: `golangmigrate/polecats/wren/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/golangmigrate/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/wren
```
...
**Your mail address:** `golangmigrate/polecats/wren`
**Your rig:** golangmigrate
**Your Witness:** `golangmigrate/witness`
...
1. Announce: "Polecat wren, checking in."
...
| Ask Witness for help | `gt mail send golangmigrate/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`golangmigrate/witness`) when:
...
```bash
gt mail send golangmigrate/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
